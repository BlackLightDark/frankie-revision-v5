...
function initFrankiePlanner() {
  try {
    ...
    if (weeksContainer) {
      weeksContainer.innerHTML = '<div style="background:white;border:1.5px solid var(--border);border-radius:10px;padding:16px;color:var(--ink-light);">Planner hit a loading wobble. Try refreshing the page once.</div>';
    }
  }
}
